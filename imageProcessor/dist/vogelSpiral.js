...
exports.vogelSpiralFolder = exports.vogelSpiral = void 0;
...
async function vogelSpiralFolder(folder) {
    await renderVogelSpiralFolder(folder, CONFIG);
}
exports.vogelSpiralFolder = vogelSpiralFolder;
async function renderVogelSpiralFolder(folder, config) {
